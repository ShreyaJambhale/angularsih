...
export class registrationFormComponent implements OnInit {
  ...
  setUserIdPass() {
    ...
    if((this.password.controls['pass1'].value!='' && this.password.controls['pass1'].value!='') && (this.password.controls['pass1'].value===this.password.controls['pass2'].value)){
      let body = {
        _id : this.userId,
        key : this.password
      }
  ...
  ngOnInit() {
    ...
    promise.subscribe((res) => {
      this.userId = Object.values(res)[0];
